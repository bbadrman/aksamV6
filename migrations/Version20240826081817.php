 ...
 */
final class Version20240826081817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE montant montant VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE montant montant NUMERIC(10, 2) DEFAULT NULL');
    }
}
