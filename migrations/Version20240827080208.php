 ...
 */
final class Version20240827080208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE debit debit NUMERIC(10, 2) DEFAULT NULL, CHANGE credit credit NUMERIC(10, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE debit debit INT DEFAULT NULL, CHANGE credit credit INT DEFAULT NULL');
    }
}
