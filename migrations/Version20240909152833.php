 ...
 */
final class Version20240909152833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat ADD type_conducteur VARCHAR(255) DEFAULT NULL, ADD conducteur VARCHAR(255) DEFAULT NULL, ADD date_permis DATETIME DEFAULT NULL, ADD date_preleve_acompte DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat DROP type_conducteur, DROP conducteur, DROP date_permis, DROP date_preleve_acompte');
    }
}
