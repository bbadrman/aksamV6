 ...
 */
final class Version20240918103121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat CHANGE cotisation cotisation NUMERIC(10, 2) DEFAULT NULL, CHANGE acompte acompte NUMERIC(10, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat CHANGE cotisation cotisation VARCHAR(255) DEFAULT NULL, CHANGE acompte acompte VARCHAR(255) DEFAULT NULL');
    }
}
