 ...
 */
final class Version20240918153307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat ADD first_reglement NUMERIC(10, 2) DEFAULT NULL, ADD second_reglement NUMERIC(10, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat DROP first_reglement, DROP second_reglement');
    }
}
