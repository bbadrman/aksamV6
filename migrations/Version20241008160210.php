 ...
 */
final class Version20241008160210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sav ADD motif_relance VARCHAR(255) DEFAULT NULL, ADD relance_at DATETIME DEFAULT NULL, ADD comment VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sav DROP motif_relance, DROP relance_at, DROP comment');
    }
}
