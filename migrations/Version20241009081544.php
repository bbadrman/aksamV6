 ...
 */
final class Version20241009081544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sav ADD status SMALLINT DEFAULT NULL, ADD coment_traiter VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sav DROP status, DROP coment_traiter');
    }
}
